...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-lg-6 mt-5 mb-5">
            <h1 style="text-align:center; color: #ba3631;">Osnovne informacije</h1>
            <!-- Buttons-->
        ...
        <div class="col-12 col-lg-6 mt-5 mb-5">
            <h1 class="mb-4" style="text-align:center; color: #ba3631;">Lokacija</h1>
            <!--Google map-->
    ...
    <form method="post" action="kontakt">
        ...
        <div class="row">
            <div class="col-12 col-lg-6 mb-3 mx-auto">
                <p style="font-weight: bold; font-size: 25px;">Vaše ime</p>
            ...
            <div class="col-12 col-lg-6 mb-3 mx-auto">
                <p style="font-weight: bold; font-size: 25px;">Vaše prezime</p>
        ...
        <div class="row">
            <div class="col-12 col-lg-6 mb-3 mx-auto">
                <p style="font-weight: bold; font-size: 25px;">E-mail adresa</p>
            ...
            <div class="col-12 col-lg-6 mb-3 mx-auto">
                <p style="font-weight: bold; font-size: 25px;">Broj telefona</p>
                <div class="input-group mb-2">
                <div class="input-group-prepend">
        ...
        <div class="row">
            <div class="col-md-6">
                 <div class="form-group">
                   <p style="font-weight: bold; font-size: 25px;">Naslov poruke</p>
        ...
        <div class="row">
            <div class="col-12 col-lg-12 mb-3 mx-auto">
                <p style="font-weight: bold; font-size: 25px;">Poruka</p>
        ...
        <div class="row">
            <div class="col-12 col-lg-12 mb-3 mx-auto">
                ...
                style="background-color:#ba3631; border-color: #ba3631; min-width:150px; min-height:50px; font-size: 30px; font-weight:bold;">
                Pošalji
                </button>
            </div>
        </div>
